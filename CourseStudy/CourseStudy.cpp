...
// CourseStudy.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCourseStudyApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCourseStudyApp

CCourseStudyApp::CCourseStudyApp()
{
...
// Единственный объект CCourseStudyApp

CCourseStudyApp theApp;


// Инициализация CCourseStudyApp

BOOL CCourseStudyApp::InitInstance()
{
